...
def get_probes(sim, net, params):
    ...
    data = {
        ...
        'vwa_a':       sim.data[net.p_vwa][::10, 0],
        'vwa_b':       sim.data[net.p_vwa][::10, 1],
        'vwa_l':       sim.data[net.p_vwa][::10, 2],
        'vwa_r':       sim.data[net.p_vwa][::10, 3],
        'vwa_w':       sim.data[net.p_vwa][::10, 4],
